...
public class frmChiTietSachMuon extends javax.swing.JFrame {

    public frmChiTietSachMuon() {
...
//        tblSachmuon.getColumnModel().getColumn(5).setPreferredWidth(40);
    ...
    private void initComponents() {
        ...
        lblTieudeTL.setText("Chi tiết phiếu mượn");
        ...
        tblSachmuon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã phiếu", "Tên sách", "Tên độc giả", "Ngày mượn", "Ngày trả", "Trạng thái"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmChiTietSachMuon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmChiTietSachMuon().setVisible(true);
            }
        });
    }
