 ...
 * @author admin
 */
public class CardDocGia extends javax.swing.JDialog {

    /**
     * Creates new form CardDocGia
     */
    public CardDocGia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CardDocGia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CardDocGia dialog = new CardDocGia(new javax.swing.JFrame(), true);
