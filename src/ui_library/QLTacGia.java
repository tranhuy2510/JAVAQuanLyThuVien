 ...
 * @author admin
 */
public final class QLTacGia extends javax.swing.JDialog {

    /**
     * Creates new form QLTacGia
     */
    // Khai báo tableModel
    ...
    public QLTacGia(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        // can giua cho form
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLTacGia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                QLTacGia dialog = new QLTacGia(new javax.swing.JFrame(), true);
